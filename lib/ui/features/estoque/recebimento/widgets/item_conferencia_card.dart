...
class _ItemConferenciaCardState extends State<ItemConferenciaCard> {
  ...
  Widget build(BuildContext context) {
    print('🔍 hasRateios: ${widget.item.hasRateios}');
    print('🔍 rateios: ${widget.item.rateios}');
    print('🔍 rateios.length: ${widget.item.rateios?.length ?? 0}');
            ...
            children: [
              ...
              if (widget.item.hasRateios)
                ...widget.item.rateios!.map((rateio) {
                  print('🔵 Mapeando rateio: ${rateio.codLote}');
                  return RateioTile(
